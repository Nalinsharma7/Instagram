...
//             src={state?state.state.pic:"loading"}
//           />
...
//             <h6>{state.state.followers!=undefined?state.state.followers.length:"0"} followers</h6>
//             <h6>{state.state.following!=undefined?state.state.following.length:"0"} following</h6>
//           </div>
//         </div>
...
const Profile  = ()=>{
    ...
    useEffect(()=>{
       if(image){
        ...
        data.append("file",image)
        data.append("upload_preset","insta-clone")
        data.append("cloud_name","dboyz3rbk")
        fetch("https://api.cloudinary.com/v1_1/dboyz3rbk/image/upload",{
            method:"post",
            body:data
        })
